...
class Patient(models.Model):
    ...
    language=models.CharField(max_length=8,null=True,default="") #null=True,blank=True
...
class Procedure(models.Model):
    ...
    category=models.CharField(max_length=50,default="")            # Surgical Procedure
    type=models.CharField(max_length=50,default="")                # Laparoscopic Appendectomy
